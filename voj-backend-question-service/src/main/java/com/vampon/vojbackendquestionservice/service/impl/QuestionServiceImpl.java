...
import com.vampon.vojbackendmodel.model.dto.question.QuestionQueryRequest;
...
import com.vampon.vojbackendquestionservice.mapper.QuestionMapper;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    public QueryWrapper<Question> getQueryWrapper(QuestionQueryRequest questionQueryRequest) {
        ...
        if (StringUtils.isNotBlank(title)) {
            queryWrapper.and(qw -> qw.like("title", title).or().like("content", title));
        }
